...
import { Clock, CheckCircle, HelpCircle, ExternalLink, Calendar, User, ArrowLeft } from 'lucide-react';
...
export function EnhancedGuidedDayView({ 
  ...
  // Build complete schedule using real schedule template data
  ...
  if (!currentBlock || currentBlockIndex >= scheduleBlocks.length) {
    return (
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 space-y-8">
          ...
          <div className="space-y-3">
            ...
            {currentBlock.type === 'assignment' && currentBlock.assignment?.canvasUrl && (
              <Button 
                variant="outline" 
                className="w-full py-3"
                onClick={() => window.open(currentBlock.assignment.canvasUrl, '_blank')}
