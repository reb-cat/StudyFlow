...
export function GuidedDayView({ 
  ...
  useEffect(() => {
    ...
    if (currentBlock) {
      // Use the single duration calculation function
      const blockDurationMinutes = calculateBlockDuration(currentBlock.startTime, currentBlock.endTime);
      ...
      {showDoneDialog && (
        <div style={{
          ...
          <div style={{
            ...
            {(() => {
              // Use the single duration calculation function
              const totalMinutes = calculateBlockDuration(currentBlock.startTime, currentBlock.endTime);
